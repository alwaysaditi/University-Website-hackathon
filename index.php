    ...
    <header class="masthead ">
        <div class="container">
            ...
            <div class="masthead-subheading">
                <h1 style="color: white;">Welcome To our WORKATEASE</h1>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                        <div class="features-icons-icon d-flex image">
                            <img src="canteen.jpg" alt="canteen">
                        </div>
                        <h3>Canteen</h3>
                        <p class="lead mb-0">Order you favourit food and pic up at your own time</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                        <div class="features-icons-icon d-flex image">
                            <img src="lost.jpg" alt="lost and found">
                        </div>
                        <h3>Lost and Found</h3>
                        <p class="lead mb-0">Add your detail about your lost thing so we can try and search it for you
                        </p>
                    </div>
                </div>
            </div>
