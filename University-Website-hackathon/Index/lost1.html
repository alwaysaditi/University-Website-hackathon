...
<head>
    ...
    <title>WORKATEASE-Lost And Found</title>
    <!-- Favicon-->
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-9 mx-auto">
                    <h1 class="mb-5">Welcome to the LOST AND FOUND section!</h1>
                    <br>
                    <h3 class="mb-5"> Please proceed to fill in your details so that we can reach you at the earliest!</h3>
                    <h1></h1>
                    <h1></h1>
                ...
                <div class="col-md-17 col-lg-8 col-xl-7 mx-auto">
                    <form>
                        <div class="form-row">
                            ...
                            <a class="btn btn-primary proceed-button" href="contactformLAF.html">Proceed</a>
